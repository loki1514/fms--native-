...
const styles = StyleSheet.create({
  ...
  itemName: { fontSize: 16,  color: '#E6EBEE' },
  itemCode: { fontSize: 11,  color: '#64748B', marginTop: 2, textTransform: 'uppercase' },
  itemMetaRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  itemMetaLabel: { fontSize: 12,  color: '#94A3B8' },
  itemMetaValue: { fontSize: 14,  color: '#E6EBEE' },
  ...
  lowBadgeText: { fontSize: 10,  color: '#FF3B30' },
  ...
  qtyLabel: { fontSize: 12,  color: '#94A3B8', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 12 },
  ...
  successTitle: { fontSize: 24,  color: '#E6EBEE', marginTop: 8 },
  successSub: { fontSize: 14,  color: '#94A3B8' },
  ...
  successItemName: { fontSize: 16,  color: '#E6EBEE' },
  successItemCode: { fontSize: 11,  color: '#64748B', marginTop: 4, textTransform: 'uppercase' },
  successQtyRow: { flexDirection: 'row', alignItems: 'baseline', gap: 6, marginTop: 16 },
  successQtyLabel: { fontSize: 12,  color: '#94A3B8' },
  successQtyValue: { fontSize: 36,  color: '#E6EBEE' },
  successQtyUnit: { fontSize: 14,  color: '#94A3B8' },
