...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 20,  color: '#E6EBEE' },
  ...
  genSelectorText: { fontSize: 13,  color: '#E6EBEE' },
  ...
  metricValue: { fontSize: 22,  letterSpacing: -0.5 },
  ...
  genCompareName: { fontSize: 13, },
  genCompareMeta: { fontSize: 10,  marginTop: 1 },
  ...
  genCompareValue: { fontSize: 12,  width: 50, textAlign: 'right' },
  ...
  segmentText: { fontSize: 12,  color: '#94A3B8' },
