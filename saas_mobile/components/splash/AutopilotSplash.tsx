  ...
  useEffect(() => {
    if (reduceMotion) {
      ...
      containerScale.value = withDelay(
        2500,
        withTiming(1.03, { duration: 500, easing: Easing.in(Easing.cubic) })
      );
    ...
    <View style={styles.root}>
      ...
      <Animated.View style={[styles.content, containerStyle]}>
        ...
        <View style={styles.taglines}>
          <Animated.Text style={[styles.tagline1, tagline1Style]}>
            Tailored enterprise workspaces.
          </Animated.Text>
          <Animated.Text style={[styles.tagline2, tagline2Style]}>
            Designed for you.
          </Animated.Text>
        </View>
      </Animated.View>
