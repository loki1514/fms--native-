/**
 * PropertySelector.tsx — Horizontal snap-scroller of property pills.
 *
 * Responsibility: Render every property as a glass pill with status dot, code,
 *   and name; highlight the active one and emit onChange when tapped.
 * Used by: dashboards that need a quick property switcher (currently optional).
 * Related: lib/properties.ts (data + status types).
 *
 * Gotcha: Negative horizontal margin (-mx-5 / sm:-mx-8) lets the scroll track
 *   bleed to the parent's padded edges. Scrollbar is hidden via inline style.
 */
