/**
 * AtmosphereLayers.tsx — Static decorative glow layers (aurora, moon halo, vignette).
 *
 * Responsibility: Lightweight ambient backdrop independent of WeatherMode.
 *   Use when a route wants atmosphere without the heavy WeatherScene runtime.
 * Used by: legacy/standalone screens — currently unused; kept for re-use.
 * Related: WeatherScene (richer, mode-driven alternative).
 */
