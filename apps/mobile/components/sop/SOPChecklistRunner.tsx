...
export default function SOPChecklistRunner({ templateId, completionId, propertyId: propId }: SOPChecklistRunnerProps) {
    ...
    <View style={styles.container}>
      <GlassCard style={styles.card}>
        <View style={styles.iconCircle}>
          <Play size={28} color="#708F96" strokeWidth={1.5} />
        </View>
        ...
        <Text style={[styles.subtitle, { color: isDark ? 'rgba(230,235,238,0.5)' : 'rgba(26,35,50,0.5)' }]}>
          Run and complete your assigned checklists with photo evidence and comments.
        </Text>
        <TouchableOpacity
          style={styles.btn}
