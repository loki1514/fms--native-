...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: 'Poppins-Bold', fontSize: 22, fontWeight: '700' },
  ...
  catText: { fontFamily: 'Poppins-Bold', fontSize: 8, letterSpacing: 1, color: '#708F96' },
  templateTitle: { fontFamily: 'Poppins-Medium', fontSize: 15, fontWeight: '600' },
  templateMeta: { fontFamily: 'Urbanist-Regular', fontSize: 12 },
});
